...
teammapping = pd.read_csv('/Users/kabariquaye/PycharmProjects/pythonProject1/venv/data/teammapping.csv')
...
datelist = [x for x in dates[0].tolist()]
...
for period in range(0,4):
        for e in range(0,len(dates)):
            try:
                ...
                a = 'https://stats.nba.com/stats/leaguedashteamstats?Conference=&DateFrom=&DateTo='
                ...
                nbadataaddonlist.insert(e, [data, datelist[e],period+1])
            except:
                pass
...
for i in range(0, len(playoffslist)):
    ...
    playoffstempaddon['Quarter'] = playoffslist[i][2]
...
for i in range(0, len(nbadataaddonlist)):
    ...
    nbadataaddontemp['Quarter'] = nbadataaddonlist[i][2]
...
nbadataaddon.to_csv(directory1+'nbadataytdaddon_quarterly.csv')
